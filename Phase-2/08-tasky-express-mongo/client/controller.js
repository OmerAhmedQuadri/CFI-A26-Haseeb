...
const getTaskById = async () => {
    try {
        ...
        if (!response.data.success) {
            console.log(chalk.redBright(response.data.message));
        }
        console.log(chalk.greenBright(response.data.message));
        console.log(response.data.data)
...
const getTaskByPriority = async () => {
    try {
        const priority = rs.question('Enter task priority: ')
...
export { getAllTasks, getTaskById, createTask, getTaskByPriority, updateTask, deleteTask }